...
class ProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        if ($this->get('discount_type') === 'amount') {
            $rules['discount'] = 'sometimes|nullable|numeric'; //|gt:unit_price |lt:unit_price
           // dd($this->get('discount_type'));
        } else {
            // $rules['discount'] = 'sometimes|required|numeric'; //|gt:100 |gte:0
            $rules['discount'] = 'sometimes|nullable|numeric'; //|gt:100 |gte:0
        }
    ...
    public function messages()
    {
        return [
            ...
            'discount.lt:unit_price'    => translate('Discount cannot be greater than unit price'),
