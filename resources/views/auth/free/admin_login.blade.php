                    ...
                    <div class="row align-items-center justify-content-center justify-content-lg-start h-100">
                        <div class="col-xxl-6 p-4 p-lg-5">
                            ...
                            <div class="size-48px mb-3 mx-auto mx-lg-0">
                                ...
                                {{-- <img src="{{ static_asset('assets/img/1.png') }}" alt="{{ translate('Site Icon')}}" class="img-fit h-100"> --}}
                                <img src="{{ asset('assets/img/1.png') }}" alt="{{ translate('Site Icon')}}" class="img-fit h-100">
                            </div>
                            <!-- Titles -->
