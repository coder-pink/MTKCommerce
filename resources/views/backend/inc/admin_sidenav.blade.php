        ...
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                {{-- @if(get_setting('system_logo_white') != null)
                    <img class="mx-auto d-block w-90px mw-100" src="{{ uploaded_asset(get_setting('system_logo_white')) }}" class="brand-icon" alt="{{ get_setting('site_name') }}">
                @else
                    <img class="mx-auto d-block w-90px  mw-100" src="{{ static_asset('assets/img/1.png') }}" class="brand-icon" alt="{{ get_setting('site_name') }}">
                @endif --}}

                @if(get_setting('system_logo_white') != null)
                <img class="mx-auto d-block img-fluid" style="max-width: 90px; height: auto;" src="{{ uploaded_asset(get_setting('system_logo_white')) }}" class="brand-icon" alt="{{ get_setting('site_name') }}">
            @else
                <img class="mx-auto d-block img-fluid" style="max-width: 90px; height: auto;" src="{{ static_asset('assets/img/1.png') }}" class="brand-icon" alt="{{ get_setting('site_name') }}">
            @endif
            </a>
        </div>
