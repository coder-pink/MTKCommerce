                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="col-auto pl-0 pr-3 d-flex align-items-center">
                        {{-- <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                            ...
                            @else
                                <img src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}"
                                    class="mw-100 h-50px  h-md-60px" height="60">
                            @endif
                        </a> --}}
                        ...
                        <a class="d-block py-2 mr-3 ml-0" href="{{ route('home') }}">
                            ...
                            @if ($header_logo != null)
                                <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}"
                                    class="mw-100 h-auto d-block logo-img" style="max-height: 40px;">
                            @else
                                <img src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}"
                                    class="mw-100 h-auto d-block logo-img" style="max-height: 60px;">
                            @endif
                        </a>
